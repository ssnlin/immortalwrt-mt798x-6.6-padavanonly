...
define Device/cmcc_a10-stock-256m
  DEVICE_VENDOR := CMCC
  DEVICE_MODEL := A10
  DEVICE_VARIANT := (stock layout 256m)
  DEVICE_DTS := mt7981b-cmcc-a10-stock-256m
  DEVICE_DTS_DIR := ../dts
  SUPPORTED_DEVICES += mediatek,mt7981-spim-snand-rfb
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware
  UBINIZE_OPTS := -E 5
  ...
  KERNEL_INITRAMFS = kernel-bin | lzma | \
	fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb with-initrd
endef
TARGET_DEVICES += cmcc_a10-stock-256m

define Device/cmcc_a10-ab-system
  DEVICE_VENDOR := CMCC
  DEVICE_MODEL := A10
  DEVICE_VARIANT := (A/B layout)
  DEVICE_DTS := mt7981b-cmcc-a10-ab-system
  DEVICE_DTS_DIR := ../dts
  SUPPORTED_DEVICES += mediatek,mt7981-spim-snand-rfb
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware
  BLOCKSIZE := 128k
  ...
  KERNEL_INITRAMFS = kernel-bin | lzma | \
    fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb with-initrd
endef
TARGET_DEVICES += cmcc_a10-ab-system

define Device/cmcc_a10-dual-ubi
  DEVICE_VENDOR := CMCC
  DEVICE_MODEL := A10
  DEVICE_VARIANT := (dual-ubi layout)
  DEVICE_DTS := mt7981b-cmcc-a10-dual-ubi
  DEVICE_DTS_DIR := ../dts
  SUPPORTED_DEVICES += mediatek,mt7981-spim-snand-rfb
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware
  UBINIZE_OPTS := -E 5
  ...
  KERNEL_INITRAMFS = kernel-bin | lzma | \
    fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb with-initrd
endef
TARGET_DEVICES += cmcc_a10-dual-ubi
...
define Device/cmcc_a10-dual-itb
  DEVICE_VENDOR := CMCC
  DEVICE_MODEL := A10
  DEVICE_DTS := mt7981b-cmcc-a10-dual-itb
  DEVICE_DTS_DIR := ../dts
  SUPPORTED_DEVICES += cmcc,a10
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware
  UBINIZE_OPTS := -E 5
  ...
  IMAGE/sysupgrade.itb := append-kernel | \
	fit gzip $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb external-static-with-rootfs | append-metadata
endef
TARGET_DEVICES += cmcc_a10-dual-itb
